...
def _all_expert_moe_tkg_static(
    ...
    # Wrap hidden/weight/bias tensors in nl.NkiTensor for slicing (shared across all T-tiles)
...
def _select_quant_scales(
    ...
    gate_w_scale_view: nl.NkiTensor,
    up_w_scale_view: nl.NkiTensor,
    down_w_scale_view: nl.NkiTensor,
    gate_up_in_scale_view: nl.NkiTensor,
    down_in_scale_view: nl.NkiTensor,
    expertIdx: int,
):
    """
    ...
    Args:
        ...
        gate_w_scale_view (nl.NkiTensor): Gate weight scale tensor view.
        up_w_scale_view (nl.NkiTensor): Up weight scale tensor view.
        down_w_scale_view (nl.NkiTensor): Down weight scale tensor view.
        gate_up_in_scale_view (nl.NkiTensor): Gate/up input scale tensor view.
        down_in_scale_view (nl.NkiTensor): Down input scale tensor view.
